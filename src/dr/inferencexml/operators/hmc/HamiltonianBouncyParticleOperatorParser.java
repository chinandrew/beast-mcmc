...
import dr.inference.operators.hmc.HamiltonianBouncyParticleOperator;
...
public class HamiltonianBouncyParticleOperatorParser extends AbstractXMLObjectParser {

    private final static String BPO_OPERATOR = "hamiltonianBouncyParticleOperator";
    ...
    public Object parseXMLObject(XMLObject xo) throws XMLParseException {
        ...
        return new HamiltonianBouncyParticleOperator(
    ...
    public Class getReturnType() {
        return HamiltonianBouncyParticleOperator.class;
    }
}